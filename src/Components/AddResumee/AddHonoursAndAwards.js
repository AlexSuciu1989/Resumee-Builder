...
function AddHonoursAndAwards({ index, honours, handleHonoursChange }) {
    ...
    return (
        <div className="AddHonours">
            ...
            <div className="AddHonours-container">
                ...
                <div className="AddHonours-subcontainer">
                    <label>Date</label>
                    <input type="date" className="AddHonours-input AddHonours-date" id="date" value={honours.date} onChange={handleChange} />
                </div>
            </div>
            <div className="AddHonours-subcontainer">
