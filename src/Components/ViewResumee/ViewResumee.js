  ...
  return (
    <div className={`ViewResumee ${template}`}>
      <div className="ViewResumee-colors-print">
        <div className="ViewResumee-cv-colors">
          <button
            ...
            onClick={() => handleTemplateChange("purple")}
            title="Purple Template Button"
          ></button>
          <button
            className="orange-button"
            onClick={() => handleTemplateChange("orange")}
            title="Orange Template Button"
          ></button>
          <button
            className="gray-button"
            onClick={() => handleTemplateChange("gray")}
            title="Gray Template Button"
          ></button>
          <button
            className="green-button"
            onClick={() => handleTemplateChange("green")}
            title="Green Template Button"
          ></button>
          <button
            className="blue-button"
            onClick={() => handleTemplateChange("blue")}
            title="Blue Template Button"
          ></button>
        </div>
      ...
      <div className="ViewResumee-subcontainer">
        ...
        {data["cv-language-skills"]?.length > 0 && (
        ...
        {data["cv-digital-skills"]?.length > 0 && (
        ...
        {data["cv-honours-and-awards"]?.length > 0 && (
        ...
        {data["cv-driving-license"]?.length > 0 && (
