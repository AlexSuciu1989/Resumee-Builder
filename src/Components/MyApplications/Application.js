...
function Application({ index, application, handleApplicationChange, handleDeleteApplication, className }) {
        ...
        <div className={`Application ${className}`}>
            ...
            <div className="Application-main-container">
                ...
                <div className="Application-container delete-button-container">
                    ...
                    <button onClick={() => handleDeleteApplication(index, application.id)} className="delete-button" name="delete-button">Delete</button>
                </div>
            </div>
        </div>
    );
